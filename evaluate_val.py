# Evaluate multiple LSTM-based models on the validation set.
# Supports CNN+LSTM and ViT+LSTM pipelines using pre-extracted features.
# Reports accuracy, F1 score, precision, and recall for each variant.
# Uses dyad-based validation split and frame truncation ratios (100%, 60%, 30%).
...
for cfg in models:
    # Load validation files based on dyad-based splitting
